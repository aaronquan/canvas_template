...
const blockShapes3 = [
    [{x:1, y:0}, {x:-1, y:0}, {x: 1, y: -1}], [{x:1, y:0}, {x:0, y:-1}, {x: 1, y: -1}],
    [{x:1, y:0}, {x:-1, y:0}, {x:0, y: -1}], [{x:1, y:1}, {x:-1, y:0}, {x:0, y: -1}]
];
...
export const comboShape4:BlockShape[] = [
    ...
    //[{x: 2, y: 0}, {x: 1, y: 0}, {x: 1, y: 1}, {x: 2, y: 1}],
    //[{x: 0, y: 0}, {x: 0, y: 1}, {x: 0, y: 2}, {x: 0, y: 3}]
];

export const comboShape5:BlockShape[] = [
    //[{x: 0, y: 0}, {x: 1, y: 0}, {x: 2, y: 0}, {x: 3, y: 0}, {x:0, y:1}],
    [{x: 0, y: 0}, {x: 0, y: 1}, {x: 1, y: 0}, {x: 1, y: 1}, {x:2, y:1}],
    [{x: 0, y: 1}, {x: 1, y: 0}, {x: 1, y: 1}, {x: 2, y: 0}, {x:2, y:1}],
]
